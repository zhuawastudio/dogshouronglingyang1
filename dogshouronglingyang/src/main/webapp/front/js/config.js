...
var centerMenu = [
    ...
    ,{
        name: '犬收藏',
        url: '../zaikuquanCollection/list.jsp'
    }
    ,{
        name: '犬收养',
        url: '../zaikuquanOrder/list.jsp'
    }
...
var indexNav = [
    {
        name: '在库犬',
        url: './pages/zaikuquan/list.jsp'
    },
    {
        name: '领养回访',
        url: './pages/lingyanghuifang/list.jsp'
    },
    {
        name: '养犬咨询',
...
var adminurl =  "http://localhost:8080/dogshouronglingyang/index.jsp";
