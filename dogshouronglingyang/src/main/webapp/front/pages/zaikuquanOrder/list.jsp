...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的收养犬 </p>
    </div>
    <!-- 标题 -->
            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <td style="width: 50px;">{{item.zaikuquanName}}</td>
                        <td style="width: 50px;">{{item.sfyimiaoValue}}</td>
                        <td style="width: 50px;">{{item.sfjueyuValue}}</td>
                        <td style="width: 80px;">{{item.tongyiValue==''?'未处理':item.tongyiValue}}</td>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 zaikuquanOrderContent 字段去除无用字符 如果字段长度大于60  就截取到60
            zaikuquanOrderContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                            // 获取列表数据
            http.request('zaikuquanOrder/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function tongyiTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=tongyi_types", 'get', {}, function (res) {
               if(res.code == 0){
