              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">接收犬只:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jieshouNumber" id="jieshouNumber"  lay-verify="integer|required"   placeholder="接收犬只" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">在库犬只:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zaikuNumber" id="zaikuNumber"  lay-verify="integer|required"   placeholder="在库犬只" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">已领养犬只:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yilingyangNumber" id="yilingyangNumber"  lay-verify="integer|required"   placeholder="已领养犬只" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
