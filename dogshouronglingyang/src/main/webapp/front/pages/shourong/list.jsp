            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">收容管理展示</span>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shourongContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shourongContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                // 获取列表数据
            http.request('shourong/list', 'get', param, function(res) {
