                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="lingyanghuifangName" id="lingyanghuifangName" placeholder="领养人" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../lingyanghuifang/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.lingyanghuifangPhoto" />
                                        <h5>{{item.lingyanghuifangName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.lingyanghuifangContent|lingyanghuifangContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 lingyanghuifangContent 字段去除无用字符 如果字段长度大于60  就截取到60
            lingyanghuifangContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#lingyanghuifangName').val() != null && jquery('#lingyanghuifangName').val() != "" && jquery('#lingyanghuifangName').val() != "null" ) {
                param['lingyanghuifangName'] = jquery('#lingyanghuifangName').val();
            }
                            // 获取列表数据
            http.request('lingyanghuifang/list', 'get', param, function(res) {
