 ...
 */
@TableName("zaikuquan")
public class ZaikuquanView extends ZaikuquanEntity implements Serializable {
	...
	public ZaikuquanView() {

	}

	public ZaikuquanView(ZaikuquanEntity zaikuquanEntity) {
		try {
			BeanUtils.copyProperties(this, zaikuquanEntity);
