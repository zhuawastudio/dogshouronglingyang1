 ...
 * @date 2021-04-12
 */
@TableName("zaikuquan_collection")
public class ZaikuquanCollectionView extends ZaikuquanCollectionEntity implements Serializable {
	...
	public ZaikuquanCollectionView() {

	}

	public ZaikuquanCollectionView(ZaikuquanCollectionEntity zaikuquanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zaikuquanCollectionEntity);
